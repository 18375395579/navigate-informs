...
for k1 in range(len(comm1)):
    ...
    c1=c1+"""<tr><td><a href="file:///Users/yujialiu/Desktop/research/webdesign/speaker_pages/comm1"""+str(k1)+""".html" onclick="javascript:void window.open("'file:///Users/yujialiu/Desktop/research/webdesign/speaker_pages/comm1"""+str(k1)+""".html'",'1408393674039','width=700,height=500,toolbar=0,menubar=0,location=0,status=1,scrollbars=1,resizable=1,left=0,top=0');return false;">"""
...
for k2 in range(len(comm2)):
    ...
    name= ''.join(glue + x if x.isupper() else x for x in name)
    c2=c2+"""<tr><td><a href="file:///Users/yujialiu/Desktop/research/webdesign/speaker_pages/comm2"""+str(k2)+""".html" onclick="javascript:void window.open("'file:///Users/yujialiu/Desktop/research/webdesign/speaker_pages/comm2"""+str(k2)+""".html'",'1408393674039','width=700,height=500,toolbar=0,menubar=0,location=0,status=1,scrollbars=1,resizable=1,left=0,top=0');return false;">"""
...
for k3 in range(len(comm3)):
    ...
    name= ''.join(glue + x if x.isupper() else x for x in name)
    c3=c3+"""<tr><td><a href="file:///Users/yujialiu/Desktop/research/webdesign/speaker_pages/comm3"""+str(k3)+""".html" onclick="javascript:void window.open("'file:///Users/yujialiu/Desktop/research/webdesign/speaker_pages/comm3"""+str(k3)+""".html'",'1408393674039','width=700,height=500,toolbar=0,menubar=0,location=0,status=1,scrollbars=1,resizable=1,left=0,top=0');return false;">"""
...
for k5 in range(len(comm5)):
    ...
    name= ''.join(glue + x if x.isupper() else x for x in name)
    c5=c5+"""<tr><td><a href="file:///Users/yujialiu/Desktop/research/webdesign/speaker_pages/comm5"""+str(k5)+""".html" onclick="javascript:void window.open("'file:///Users/yujialiu/Desktop/research/webdesign/speaker_pages/comm5"""+str(k5)+""".html'",'1408393674039','width=700,height=500,toolbar=0,menubar=0,location=0,status=1,scrollbars=1,resizable=1,left=0,top=0');return false;">"""
